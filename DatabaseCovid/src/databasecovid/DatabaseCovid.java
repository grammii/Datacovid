 ...
 * @author Gramm
 */
public class DatabaseCovid {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args)throws FileNotFoundException, JSONException  {
        JsonReader reader = Json.createReader(new FileReader("‪C:\\Users\\Gramm\\Desktop\\textdata.txt"));
        ...
        for(int i = 0; i < arr.length(); i++) {
            ...
            Datacovid cov = new Datacovid(yearnum, weeknum, new_case, total_case, new_case_excludeabroad, total_case_excludeabroad,
    ...
    public static void persist(Object object) {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("DatabaseCovidPU");
