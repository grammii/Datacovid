...
public class AddData{
    public static void main(String[] args)throws FileNotFoundException, JSONException  {
        JsonReader reader = Json.createReader(new FileReader("‪‪C:\\Users\\Gramm\\Desktop\\Textfild.txt"));
        ...
        for(int i = 0; i < arr.length(); i++) {
            ...
            Coviddata2 cov = new Coviddata2(yearnum, weeknum ,province, new_case, total_case, new_case_excludeabroad, total_case_excludeabroad,
    ...
    public static void persist(Object object) {
        EntityManagerFactory emf = Persistence.createEntityManagerFactory("addDataPU");
